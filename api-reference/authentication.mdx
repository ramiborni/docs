...
```bash
curl https://integration-api-gateway.agreeablesea-e4815929.swedencentral.azurecontainerapps.io/api/account/messaging/connection-request \
...
const config = {
  sandbox: {
    ...
    baseUrl: 'https://integration-api-gateway.agreeablesea-e4815929.swedencentral.azurecontainerapps.io/api/account'
  },
  production: {
