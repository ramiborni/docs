...
```bash
curl https://integration-api-gateway.agreeablesea-e4815929.swedencentral.azurecontainerapps.io/api/linkedin/messaging/connection-request \
  -H "X-API-KEY: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "leadUrl": "https://www.linkedin.com/in/john-doe",
    "linkedinAccountId": "clxxx123456",
    "connectionNote": "Hi, I'\''d love to connect!"
  }'
```
...
| Environment | Key Format | Description |
|------------|-----------|-------------|
| Sandbox | Separate sandbox key | For development and testing |
| Production | Production key | For live integration |
...
const config = {
  sandbox: {
    apiKey: process.env.SENDPILOT_SANDBOX_KEY,
    baseUrl: 'https://integration-api-gateway.agreeablesea-e4815929.swedencentral.azurecontainerapps.io/api/linkedin'
  },
  production: {
